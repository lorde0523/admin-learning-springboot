...
import com.example.admin.role.service.MyBatisAdminRoleService;
...
public class MyBatisAdminRoleController {

    private final MyBatisAdminRoleService roleService;

    public MyBatisAdminRoleController(MyBatisAdminRoleService roleService) {
    ...
    public ResponseEntity<RoleDtos.RoleResponse> create(@Valid @RequestBody RoleDtos.RoleRequest request) {
        ...
        return ResponseEntity.created(URI.create("/api/mybatis/roles/" + response.id())).body(response);
    }
