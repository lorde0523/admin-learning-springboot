...
import com.example.admin.user.service.JpaAdminUserService;
...
public class JpaAdminUserController {

    private final JpaAdminUserService userService;

    public JpaAdminUserController(JpaAdminUserService userService) {
